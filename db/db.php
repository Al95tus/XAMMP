...
// Эту строку следует раскомментировать при первичном запуске приложения, чтобы создать в БД необходимые таблицы. После первичного запуска строку можно удалить или закомментировать. 
